        ...
        <div className='w-full h-auto mt-16 md:pl-40 mb-10'>
            <div className='mt-8'>
                ...
                <div className='flex items-center justify-between py-2'>
                    ...
                    <ul className='flex items-center space-x-1 text-blue-50 text-sm'>
                        <li className='cursor-pointer px-1 bg-blue-600 rounded-sm'>1D</li>
                        <li className='cursor-pointer px-1 bg-blue-600 rounded-sm'>1W</li>
                        <li className='cursor-pointer px-1 bg-blue-600 rounded-sm'>1M</li>
                        <li className='cursor-pointer px-1 bg-blue-600 rounded-sm'>1Y</li>
                        <li className='cursor-pointer px-1 bg-blue-600 rounded-sm'>ALL</li>
                    </ul>
                </div>
            </div>
