...
const Sidebar = () => {
    ...
    return (
        <div className=" hidden grow bg-gray-100 text-gray-900 h-auto mt-16 px-4 md:w-64 border-r border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white md:inline-block">
